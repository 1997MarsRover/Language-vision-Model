...
with gr.Blocks() as demo:
  gr.HTML("<h1><center>☯️ Sensei</center></h1>")
  gr.HTML("<h3><center>A tiny vision language model. <a href='https://github.com/1997MarsRover/sensei' target='blank_'>GitHub</a></center></h3>")
  with gr.Group():
    with gr.Row():
